  ...
  <span class="docentes-elegir">
    ...
    <header class="header">
      <span class="header-icono back-icono">
        <span class="icono"><img src="@/assets/icono-back.png" alt="Atrás"></span>
      </span>
    ...
    <main class="main-contenido">
      ...
      <span class="titulo-actividad">
        Actividad: <span class="nito">{{ actividadActual ? actividadActual.nombre : 'Cargando...' }}</span>
      </span>
      ...
      <div class="visor-formato">
        ...
        <span class="contenedor-documento">
          ...
          <ConstanciaTutoria 
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 10" 
            :datos="datosDocumento"
            class="documento-escalado" 
            id="documento-para-imprimir"
          />
          <div v-else-if="actividadActual && actividadActual.idTipoDocumento === 10" class="mensaje-estado">
            Cargando datos del documento...
          </div>
          <ConstanciaAcreditacion
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 20 && datosDocumento.programaEducativo"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaComplementaria
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 30 && datosDocumento.numOficio"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaRED
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 40 && datosDocumento.asignatura"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaManual
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 50 && datosDocumento.carrera"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaEstrategia
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 60 && datosDocumento.estrategia"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaProductos
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 80 && datosDocumento.producto"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaDiplomado
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 70 && datosDocumento.diplomado"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
            />
          <ConstanciaExencion
            v-else-if="actividadActual && [90, 312, 313, 315, 314, 316].includes(actividadActual.idTipoDocumento) && datosDocumento.nombreEstudiante"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <OficioComision
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 100 && datosDocumento.oficio"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <OficioComisionTecNM
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 110 && datosDocumento.oficio"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <OficioPensamientoCritico
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 120 && datosDocumento.oficio"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <OficioAmbientesVirtuales
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 130 && datosDocumento.oficio"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaRH
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 140 && datosDocumento.oficio"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <CartaExclusividad
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 150 && datosDocumento.filiacion"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaInvestigacionVue
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 155 && datosDocumento.tituloProyecto"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaCVU
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 160 && datosDocumento.registro"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaAlumnos
            v-else-if="actividadActual && (actividadActual.idTipoDocumento === 170 || actividadActual.idTipoDocumento === 183) && datosDocumento.materias"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <HorarioActividades
            v-else-if="actividadActual && (actividadActual.idTipoDocumento === 180 || actividadActual.idTipoDocumento === 181 || actividadActual.idTipoDocumento === 182) && datosDocumento.encabezado"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <TalonPago
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 190 && datosDocumento.rfc"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <CedulaProfesional
            v-else-if="(actividadActual && [195, 196, 216].includes(actividadActual.idTipoDocumento)) && datosDocumento.numeroCedula"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaPropuesta
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 200 && datosDocumento.nombreProyecto"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <OficioSabatico
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 210 && datosDocumento.oficio"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <LiberacionActividades
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 220 && datosDocumento.semestre"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          ...
          <LiberacionAcademicas
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 230 && datosDocumento.semestre"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ReporteInvestigacion
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 240 && datosDocumento.proyectos"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <EvaluacionDocente
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 250 && datosDocumento.calificacion"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <OficioInclusiva
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 131 && datosDocumento.oficio"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <OficioEstrategicos
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 132 && datosDocumento.oficio"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaProyectosGenerico
            v-else-if="actividadActual && [421, 422, 423].includes(actividadActual.idTipoDocumento) && datosDocumento.proyectos"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaAsesoriaCBVue
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 410 && datosDocumento.nombreDocente"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaAsesoriaGenericVue
            v-else-if="actividadActual && [431, 432, 433, 434, 435, 436].includes(actividadActual.idTipoDocumento) && datosDocumento.nombreDocente"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaConcursoGenericVue
            v-else-if="actividadActual && [441, 442, 443, 444, 445, 446].includes(actividadActual.idTipoDocumento) && datosDocumento.nombreDocente"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaJuradoGenericVue
            v-else-if="actividadActual && [451, 452, 453, 454].includes(actividadActual.idTipoDocumento) && datosDocumento.nombreDocente"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaComiteGenericVue
            v-else-if="actividadActual && [461, 462, 463].includes(actividadActual.idTipoDocumento) && datosDocumento.nombreDocente"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaAuditoriaGenericVue
            v-else-if="actividadActual && [471, 472, 473, 474].includes(actividadActual.idTipoDocumento) && datosDocumento.nombreDocente"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaModuloEspecialidadVue
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 482 && datosDocumento.nombreDocente"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaDesarrolloCurricularVue
            v-else-if="actividadActual && [481, 483].includes(actividadActual.idTipoDocumento) && datosDocumento.nombreDocente"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <ConstanciaSinodalGenericVue
            v-else-if="actividadActual && [321, 322, 323, 324, 325].includes(actividadActual.idTipoDocumento) && datosDocumento.nombreDocente"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
          <LicenciaGravidezVue
            v-else-if="actividadActual && actividadActual.idTipoDocumento === 215 && datosDocumento.nombreDocente"
            :datos="datosDocumento"
            class="documento-escalado"
            id="documento-para-imprimir"
          />
      ...
      <div style="margin-top: 20px;">
        <button @click="descargarPDF" class="btn-descargar" v-if="!cargando && actividadActual">
          Descargar PDF
        </button>
      </div>
...
const formatoActual = computed(() => {
  ...
  if (actividadActual.value.idTipoDocumento === 10) return "Constancia PIT (1.1.5)";
  if (actividadActual.value.idTipoDocumento === 20) return "Actividad de Acreditación (1.1.6)";
  if (actividadActual.value.idTipoDocumento === 30) return "Actividad Complementaria (1.1.7)";
  if (actividadActual.value.idTipoDocumento === 40) return "Recurso Educativo Digital (1.2.1.1)";
  if (actividadActual.value.idTipoDocumento === 50) return "Manual de Prácticas (1.2.1.2)";
  if (actividadActual.value.idTipoDocumento === 60) return "Estrategias Innovadoras (1.2.1.3)";
  if (actividadActual.value.idTipoDocumento === 80) return "Constancia Productos (1.2.1.4)";
  if (actividadActual.value.idTipoDocumento === 70) return "Instructor Diplomado (1.2.2.4)";
  if (actividadActual.value.idTipoDocumento === 90) return "Exención Examen Profesional (1.3.1.1)";
  if (actividadActual.value.idTipoDocumento === 100) return "Oficio Comisión (1.2.2.1)";
  if (actividadActual.value.idTipoDocumento === 110) return "Oficio Comisión TecNM (1.2.2.2)";
  if (actividadActual.value.idTipoDocumento === 120) return "Comisión Pensamiento Crítico (1.2.2.3)";
  if (actividadActual.value.idTipoDocumento === 130) return "Comisión Ambientes Virtuales (1.2.2.5)";
  if (actividadActual.value.idTipoDocumento === 131) return "Comisión Inclusiva (1.2.2.6)";
  if (actividadActual.value.idTipoDocumento === 132) return "Comisión Estratégicos (1.2.2.7)";
  if (actividadActual.value.idTipoDocumento === 140) return "Constancia Recursos Humanos (01)";
  if (actividadActual.value.idTipoDocumento === 150) return "Carta Exclusividad Laboral (04)";
  if (actividadActual.value.idTipoDocumento === 155) return "Constancia Proyecto Investigación (05)";
  if (actividadActual.value.idTipoDocumento === 160) return "Constancia CVU (06)";
  if (actividadActual.value.idTipoDocumento === 170) return "Constancia Alumnos Atendidos (07)";
  if (actividadActual.value.idTipoDocumento === 180) return "Horario de Actividades (1.1.1)";
  if (actividadActual.value.idTipoDocumento === 181) return "Asignaturas Adicionales (1.1.2)";
  if (actividadActual.value.idTipoDocumento === 182) return "Horario Posgrado (1.1.3)";
  if (actividadActual.value.idTipoDocumento === 183) return "Estudiantes Atendidos (1.1.4)";
  if (actividadActual.value.idTipoDocumento === 190) return "Talón de Pago (02)";
  if (actividadActual.value.idTipoDocumento === 195) return "Cédula Doctorado (1.4.9.1)";
  if (actividadActual.value.idTipoDocumento === 196) return "Cédula Maestría (1.4.9.2)";
  if (actividadActual.value.idTipoDocumento === 200) return "Propuesta Programa (1.4.8.3)";
  if (actividadActual.value.idTipoDocumento === 210) return "Oficio Sabático/Beca (08)";
  if (actividadActual.value.idTipoDocumento === 215) return "Licencia por Gravidez (09)";
  if (actividadActual.value.idTipoDocumento === 216) return "Cédula Profesional (10)";
  if (actividadActual.value.idTipoDocumento === 220) return "Liberación de Actividades Docentes (11)";
  if (actividadActual.value.idTipoDocumento === 230) return "Liberación de Actividades Académicas (12)";
  if (actividadActual.value.idTipoDocumento === 240) return "Reporte de Investigación (13)";
  if (actividadActual.value.idTipoDocumento === 250) return "Evaluación Docente (14)";
  if (actividadActual.value.idTipoDocumento === 312) return "Exención Especialización (1.3.1.2)";
  if (actividadActual.value.idTipoDocumento === 313) return "Exención Maestría (1.3.1.3)";
  if (actividadActual.value.idTipoDocumento === 315) return "Exención Doctorado (1.3.1.5)";
  if (actividadActual.value.idTipoDocumento === 314) return "Codirección Maestría (1.3.1.4)";
  if (actividadActual.value.idTipoDocumento === 316) return "Codirección Doctorado (1.3.1.6)";
  if (actividadActual.value.idTipoDocumento === 410) return "Asesoría en Ciencias Básicas (1.4.1)";
  if (actividadActual.value.idTipoDocumento === 421) return "Proyectos Locales (1.4.2.1)";
  if (actividadActual.value.idTipoDocumento === 422) return "Proyectos Nacionales (1.4.2.2)";
  if (actividadActual.value.idTipoDocumento === 423) return "Proyectos Internacionales (1.4.2.3)";
  if (actividadActual.value.idTipoDocumento === 431) return "Asesoría Concurso 3er Lugar Nacional (1.4.3.1)";
  if (actividadActual.value.idTipoDocumento === 432) return "Asesoría Concurso 2do Lugar Nacional (1.4.3.2)";
  if (actividadActual.value.idTipoDocumento === 433) return "Asesoría Concurso 1er Lugar Nacional (1.4.3.3)";
  if (actividadActual.value.idTipoDocumento === 434) return "Asesoría Concurso 3er Lugar Internacional (1.4.3.4)";
  if (actividadActual.value.idTipoDocumento === 435) return "Asesoría Concurso 2do Lugar Internacional (1.4.3.5)";
  if (actividadActual.value.idTipoDocumento === 436) return "Asesoría Concurso 1er Lugar Internacional (1.4.3.6)";
  if (actividadActual.value.idTipoDocumento === 441) return "Coordinador Concurso General Local (1.4.4.1)";
  if (actividadActual.value.idTipoDocumento === 442) return "Coordinador Concurso General Regional(1.4.4.2)";
  if (actividadActual.value.idTipoDocumento === 443) return "Coordinador Concurso General Nacional o Internacional (1.4.4.3)";
  if (actividadActual.value.idTipoDocumento === 444) return "Colaborador Concurso Local (1.4.4.4)";
  if (actividadActual.value.idTipoDocumento === 445) return "Colaborador Concurso Regional (1.4.4.5)";
  if (actividadActual.value.idTipoDocumento === 446) return "Colaborador Concurso Nacional o Internacional (1.4.4.6)";
  if (actividadActual.value.idTipoDocumento === 451) return "Jurado Local (1.4.5.1)";
  if (actividadActual.value.idTipoDocumento === 452) return "Jurado Regional (1.4.5.2)";
  if (actividadActual.value.idTipoDocumento === 453) return "Jurado Nacional (1.4.5.3)";
  if (actividadActual.value.idTipoDocumento === 454) return "Jurado Internacional (1.4.5.4)";
  if (actividadActual.value.idTipoDocumento === 461) return "Comité Local o Regional(1.4.6.1)";
  if (actividadActual.value.idTipoDocumento === 462) return "Comité Nacional (1.4.6.2)";
  if (actividadActual.value.idTipoDocumento === 463) return "Comité Internacional (1.4.6.3)";
  if (actividadActual.value.idTipoDocumento === 471) return "Constancia Auditor Interno en la Institución (1.4.7.1)";
  if (actividadActual.value.idTipoDocumento === 472) return "Constancia Auditor Interno Fuera de la Institución (1.4.7.2)";
  if (actividadActual.value.idTipoDocumento === 473) return "Constancia Auditor Líder en la Institución (1.4.7.3)";
  if (actividadActual.value.idTipoDocumento === 474) return "Constancia Auditor Líder Fuera de la Institución (1.4.7.4)";
  if (actividadActual.value.idTipoDocumento === 482) return "Constancia Módulo de Especialidad (1.4.8.2)";
  if (actividadActual.value.idTipoDocumento === 481) return "Constancia de Desarrollo Curricular Local (1.4.8.1.1)";
  if (actividadActual.value.idTipoDocumento === 483) return "Constancia de Desarrollo Curricular Nacional (1.4.8.1.2)"
  if (actividadActual.value.idTipoDocumento === 321) return "Constancia de Sinodal Técnico Superior (1.3.2.1)";
  if (actividadActual.value.idTipoDocumento === 322) return "Constancia de Sinodal Licenciatura (1.3.2.2)";
  if (actividadActual.value.idTipoDocumento === 323) return "Constancia de Sinodal Especialización (1.3.2.3)";
  if (actividadActual.value.idTipoDocumento === 324) return "Constancia de Sinodal Maestría (1.3.2.4)";
  if (actividadActual.value.idTipoDocumento === 325) return "Constancia de Sinodal Técnico Doctorado (1.3.2.5)";
...
const cargarListaActividades = async () => {
  try {
    const res = await axios.get('http://localhost:3001/api/docenteactividad');
...
const cargarDetalleDocumento = async () => {
  ...
  try {
    ...
    else if (actual.idTipoDocumento === 195 || actual.idTipoDocumento === 196) {
    ...
    else if ([431, 432, 433, 434, 435, 436].includes(actual.idTipoDocumento)) {
        const url = `http://localhost:3001/api/docenteactividad/${actual.idDocenteActividad}/asesoria-generic`;
        const res = await axios.get(url);
        datosDocumento.value = res.data;
    }
    else if ([441, 442, 443, 444, 445, 446].includes(actual.idTipoDocumento)) {
...
.header-logo img { width: 400px; margin: -150px; }
.header-icono { width: 40px; }
.icono img { width: 40px; cursor: pointer; }
...
.titulo-actividad { font-size: 1.8em; }
...
.flecha { background: none; border: none; cursor: pointer; }
.flecha img { width: 30px; }
.flecha:disabled { opacity: 0.3; cursor: not-allowed; }
...
.texto-formato { margin-top: 15px; font-size: 1.3em; }
...
.btn-descargar:hover { background-color: #2c5294; }
...
.footer img { width: 50px; cursor: pointer; }
</style>