<template>
  <div class="hoja-carta">
    ...
    <div class="contenido-interno">
        ...
        <p class="subtitulo-doc">(En proceso o terminados, debidamente autorizados y registrados)</p>
            ...
            <table class="tabla-proyectos">
                ...
                <tbody>
                    ...
                    <tr v-if="!datos.proyectos || datos.proyectos.length === 0">
                        <td colspan="3" class="sin-datos">Sin proyectos registrados en este periodo.</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <p class="nota-pie">
            * Nota: Se anexan las carátulas de autorización o constancias de registro correspondientes a los proyectos listados.
        </p>
...
.bloque-fecha { display: flex; justify-content: flex-end; margin-bottom: 20px; }
.fila-dato.derecha { text-align: right; }
.linea-dato { font-weight: bold; margin-top: 5px; }

/* Títulos */
.titulo-doc { text-align: center; font-weight: bold; margin-bottom: 5px; font-size: 12pt; }
.subtitulo-doc { text-align: center; font-style: italic; margin-bottom: 25px; font-size: 9pt; }

/* Datos Generales */
.datos-generales { margin-bottom: 20px; border: 1px solid #ccc; padding: 15px; background-color: #f9f9f9; }
.fila-info { margin-bottom: 8px; display: flex; }
.label { font-weight: bold; width: 150px; }
.valor { flex: 1; border-bottom: 1px dotted #999; }

/* Tabla */
.contenedor-tabla { margin-bottom: 20px; }
.tabla-proyectos { width: 100%; border-collapse: collapse; font-size: 9pt; }
.tabla-proyectos th, .tabla-proyectos td { border: 1px solid black; padding: 8px; vertical-align: middle; }
.tabla-proyectos th { background-color: #e0e0e0; font-weight: bold; text-align: center; }

.col-titulo { width: 50%; }
.col-estatus { width: 20%; }
.col-registro { width: 30%; }
.text-left { text-align: left; }
.center { text-align: center; }
.sin-datos { text-align: center; font-style: italic; padding: 20px; color: #666; }

.nota-pie { font-size: 8pt; font-style: italic; margin-bottom: 30px; }

/* Firmas */
.seccion-firmas { display: flex; justify-content: space-around; margin-top: 20px; }
