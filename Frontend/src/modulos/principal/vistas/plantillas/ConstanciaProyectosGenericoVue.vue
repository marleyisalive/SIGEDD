    ...
    <div class="contenido-interno">
      ...
      <div class="cuerpo-texto">
        <p>
          ...
          <strong>{{ datos.nombreDocente }}</strong
          >, profesor(a) adscrito(a) al Departamento de
          <strong>{{ datos.departamento }}</strong
          >, participó en el (los) proyecto(s) que se enlistan a continuación,
          durante el periodo <strong>{{ datos.periodo }}</strong
          >.
        </p>
      </div>
