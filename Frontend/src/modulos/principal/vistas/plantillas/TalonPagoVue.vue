<template>
  <div class="hoja-talon">
    <div class="marco-principal">
      <table class="tabla-header">
        <tbody>
          <tr>
            ...
            <td class="col-titulo-azul" colspan="4">COMPROBANTE DE PAGO</td>
          </tr>
          <tr class="fila-datos">
      ...
      <table class="tabla-contenedor-listas">
        <tbody>
          <tr>
            <td class="celda-mitad borde-der">
              <table class="tabla-items">
                ...
                <tbody>
                  ...
                  <tr
                    v-if="!datos.percepciones || datos.percepciones.length < 8"
                  >
      ...
      <table class="tabla-footer">
        <tbody>
          <tr>
            <td class="footer-izq">
              <div class="nota-ajuste">
                05 PAGO POR AJUSTE AL CALENDARIO DE 360 A 365 DÍAS
              </div>
              <div class="sello-contenedor">
                <div class="sello-azul-fondo">
                  <p class="txt-grande">
                    GENERADO DESDE LA OFICINA VIRTUAL TECNM
                  </p>
                  <p class="txt-chico">
                    Sello digital de validez oficial | Cadena Original
                  </p>
                </div>
