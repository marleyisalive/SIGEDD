    ...
    <div class="contenido-interno">
      <div class="bloque-encabezado">
        ...
        <div class="datos-bloque">
          <p class="dato-linea">
            Oficio No. <u>{{ datos.oficio }}</u>
          </p>
          <p class="dato-linea">
            <strong>ASUNTO:</strong> Constancia de Participación en Comités de
            Evaluación.
          </p>
          <p class="dato-linea fecha">
            Culiacán, Sinaloa, a {{ datos.fechaTexto }}.
          </p>
        </div>
      </div>
      ...
      <div class="cuerpo-texto">
        <p>
          El/la que suscribe, <strong>{{ datos.firmaDirector }}</strong
          >, Director/a del Instituto Tecnológico de Culiacán, por medio de la
          presente,
        </p>
        <p class="hace-constar">H A C E C O N S T A R</p>
        <p>
          Que el (la) docente, <strong>{{ datos.nombreDocente }}</strong
          >, adscrito(a) al Departamento de {{ datos.departamento }}, participó
          activamente como integrante de diversos
          <strong>COMITÉS DE EVALUACIÓN Y/O ACREDITACIÓN</strong> durante el
          periodo <strong>{{ datos.periodo }}</strong
          >, desempeñando funciones de arbitraje y dictaminación técnica en los
      ...
      <div class="cuerpo-texto">
        <p class="parrafo-cierre">
          El (la) profesor(a) cumplió cabalmente con los criterios de
          objetividad, confidencialidad y rigor académico exigidos por dichos
          organismos, contribuyendo al prestigio y reconocimiento de nuestra
          institución en los ámbitos mencionados.
        </p>
        <p>
          Se extiende la presente constancia para los fines de acreditación en
...
.texto-peque {
  font-size: 7.5pt;
} /* Texto un poco más chico para que quepa más info */
...
.atentamente {
  ...
  font-size: 9pt;
  text-align: left;
} /* Menos espacio antes de la firma */
.firma-centro {
  width: 70%;
  margin: 0 auto;
}
