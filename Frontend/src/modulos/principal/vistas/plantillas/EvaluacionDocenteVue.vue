<template>
  <div class="hoja-carta">
    ...
    <div class="contenido-interno">
        ...
        <table class="tabla-resultados">
          ...
          <tfoot>
            <tr class="fila-final">
              ...
              <td class="text-center resultado-final">
                {{ datos.calificacion }}
              </td>
            </tr>
          </tfoot>
      ...
      <p class="nota-legal">
        La presente evaluación corresponde al desempeño frente a grupo y cumple
        con los lineamientos establecidos por el Tecnológico Nacional de México.
      </p>
