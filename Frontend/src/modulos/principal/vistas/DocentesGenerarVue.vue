  ...
  <span class="docentes-generar">
    ...
    <main class="main-contenido">
      ...
      <div class="acciones-globales">
        ...
        <button class="btn-global btn-verde" @click="descargarExpedienteCompleto">
      ...
      <div class="tabla-contenedor">
        ...
        <div class="fila" v-for="doc in listaDocumentos" :key="doc.idDocenteActividad">
          
          <div class="col-nombre">
            <strong class="texto-formato-oficial">{{ obtenerNombreFormato(doc.idTipoDocumento) }}</strong>
          ...
          <div class="col-acciones">
            <button class="btn-icon download" @click="descargarUnicoPDF(doc)" title="Descargar PDF">
               <img src="@/assets/icono-generar.png" alt="ZIP">
            </button>
            
            <button class="btn-icon view" @click="irADetalleUnico(doc.idDocenteActividad)" title="Ver Detalle">
...
const mapaComponentes = {
  10: ConstanciaPIT, 20: ConstanciaAcreditacion, 30: ConstanciaComplementaria,
  40: ConstanciaRED, 50: ConstanciaManual, 60: ConstanciaEstrategia,
  70: ConstanciaDiplomado, 80: ConstanciaProductos, 90: ConstanciaExencion,
  100: OficioComision, 110: OficioComisionTecNM, 120: OficioPensamientoCritico,
  130: OficioAmbientesVirtuales, 131: OficioInclusiva, 132: OficioEstrategicos, 140: ConstanciaRH, 150: CartaExclusividad, 155: ConstanciaInvestigacionVue,
  160: ConstanciaCVU, 170: ConstanciaAlumnos, 180: HorarioActividades, 181: HorarioActividades, 182: HorarioActividades, 183: ConstanciaAlumnos,
  190: TalonPagoVue, 195: CedulaProfesional, 196: CedulaProfesional, 200: ConstanciaPropuesta, 210: OficioSabatico, 215: LicenciaGravidezVue, 216: CedulaProfesional,
  220: LiberacionActividades, 230: LiberacionAcademicas, 240: ReporteInvestigacion, 250: EvaluacionDocente, 312: ConstanciaExencion, 
  313: ConstanciaExencion, 315: ConstanciaExencion, 314: ConstanciaExencion, 316: ConstanciaExencion, 410: ConstanciaAsesoriaCBVue,
  421: ConstanciaProyectosGenerico, 422: ConstanciaProyectosGenerico, 423: ConstanciaProyectosGenerico, 431: ConstanciaAsesoriaGenericVue, 
  432: ConstanciaAsesoriaGenericVue, 433: ConstanciaAsesoriaGenericVue, 434: ConstanciaAsesoriaGenericVue, 435: ConstanciaAsesoriaGenericVue,
  436: ConstanciaAsesoriaGenericVue, 441: ConstanciaConcursoGenericVue, 442: ConstanciaConcursoGenericVue, 443: ConstanciaConcursoGenericVue,
  444: ConstanciaConcursoGenericVue, 445: ConstanciaConcursoGenericVue, 446: ConstanciaConcursoGenericVue, 451: ConstanciaJuradoGenericVue, 
  452: ConstanciaJuradoGenericVue, 453: ConstanciaJuradoGenericVue, 454: ConstanciaJuradoGenericVue, 461: ConstanciaComiteGenericVue,
  462: ConstanciaComiteGenericVue, 463: ConstanciaComiteGenericVue, 471: ConstanciaAuditoriaGenericVue, 472: ConstanciaAuditoriaGenericVue,
  473: ConstanciaAuditoriaGenericVue, 474: ConstanciaAuditoriaGenericVue, 482: ConstanciaModuloEspecialidadVue, 481: ConstanciaDesarrolloCurricularVue, 
  483: ConstanciaDesarrolloCurricularVue, 321: ConstanciaSinodalGenericVue, 322: ConstanciaSinodalGenericVue, 323: ConstanciaSinodalGenericVue,
  324: ConstanciaSinodalGenericVue, 325: ConstanciaSinodalGenericVue
};
...
const getEndpointSuffix = (id) => {
    const map = {
        10: 'pit', 20: 'acreditacion', 30: 'complementaria', 40: 'red',
        50: 'manual', 60: 'estrategia', 70: 'diplomado', 80: 'productos',
        90: 'exencion', 100: 'comision', 110: 'comision-tecnm',
        120: 'comision-pensamiento', 130: 'comision-ambientes', 131: 'comision-inclusiva', 132: 'comision-estrategicas',
        140: 'constancia-rh', 150: 'exclusividad', 155: 'investigacion-05', 160: 'cvu',
        170: 'alumnos-atendidos', 180: 'horario', 181: 'horario-adicional', 
        182: 'horario-posgrado', 183: 'estudiantes-114', 190: 'talon', 195: 'cedula', 
        196: 'cedula', 200: 'propuesta', 210: 'sabatico', 215: 'licencia-gravidez', 216: 'cedula', 220: 'liberacion', 
        230: 'liberacion-academica', 240: 'reporte-investigacion', 250: 'evaluacion-docente', 312: 'exencion', 313: 'exencion', 
        315: 'exencion', 314: 'exencion', 316: 'exencion', 410: 'asesoria-cb', 421: 'constancia-proyectos', 422: 'constancia-proyectos', 423: 'constancia-proyectos',
        431: 'asesoria-generic', 432: 'asesoria-generic', 433: 'asesoria-generic', 434: 'asesoria-generic', 435: 'asesoria-generic', 436: 'asesoria-generic',
        441: 'concurso-generic', 442: 'concurso-generic', 443: 'concurso-generic', 444: 'concurso-generic', 445: 'concurso-generic', 446: 'concurso-generic',
        451: 'jurado-generic', 452: 'jurado-generic', 453: 'jurado-generic', 454: 'jurado-generic', 461: 'comite-generic', 462: 'comite-generic', 463: 'comite-generic',
        471: 'auditoria-generic', 472: 'auditoria-generic', 473: 'auditoria-generic', 474: 'auditoria-generic', 482: 'modulo-especialidad', 481: 'desarrollo-curricular', 
        483: 'desarrollo-curricular', 321: 'sinodal-generic', 322: 'sinodal-generic', 323: 'sinodal-generic', 324: 'sinodal-generic', 325: 'sinodal-generic'
    };
    return map[id];
};
...
// --- NAVEGACIÓN ---
const irAIndividual = () => { router.push({ name: 'docenteselegir' }); };
...
const descargarExpedienteCompleto = async () => {
    ...
    try {
        ...
        link.click();
    } catch (e) { console.error(e); } finally { componenteActivo.value = null; cargando.value = false; progreso.value = 0; }
};
</script>
...
.btn-global:hover { transform: translateY(-3px); }
.btn-azul { background-color: var(--azul-btn); }
.btn-verde { background-color: var(--verde-btn); }
.btn-icon-white { width: 28px; filter: brightness(0) invert(1); }
...
.col-nombre { flex: 4; text-align: left; display: flex; flex-direction: column; }
/* .col-tipo ELIMINADO */
.col-fecha  { flex: 1; text-align: center; font-size: 0.9em; color: #666; }
.col-acciones { flex: 1; display: flex; justify-content: center; gap: 10px; }

.texto-formato-oficial { font-size: 1.05em; color: var(--color-text-osc); }
.texto-actividad-detalle { font-size: 0.85em; color: #777; margin-top: 2px; }
...
.btn-icon.download:hover { background-color: #e8f5e9; border-color: var(--verde-btn); }
.btn-icon.view:hover { background-color: #e3f2fd; border-color: var(--azul-btn); }

/* LOADING Y EMPTY */
.loading-box { padding: 30px; text-align: center; background: #f9f9f9; }
.empty-state { padding: 40px; text-align: center; color: #888; font-style: italic; }

.progress-bar { width: 100%; height: 6px; background: #ddd; border-radius: 3px; margin-top: 10px; overflow: hidden; }
.progress-fill { height: 100%; background: var(--verde-btn); transition: width 0.3s; }
