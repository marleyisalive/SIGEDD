<template>
  <div class="container mt-5" v-if="docente[0]">
    <div class="card">
      ...
      <div class="card-body">
        <Form
          :validation-schema="DocenteSchema"
          @submit="onTodoBien"
          :initial-values="{
            idDocente: docente[0].idDocente,
            idUsuario: docente[0].idUsuario,
            filiacion: docente[0].filiacion,
            idNivelEstudio: docente[0].idNivelEstudio,
            idDepartamento: docente[0].idDepartamento,
            idPlaza: docente[0].idPlaza,
            estatusExclusividad: docente[0].estatusExclusividad,
            folioEdd: docente[0].folioEdd,
          }"
        >
          <div class="mb-3">
...
const onTodoBien = async (values: any) => {
  await actualizarDocente(values);
};
